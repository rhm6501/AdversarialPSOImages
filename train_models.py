...
## Modified by Rayan Mosli (rhm6501@rit.edu)
...
train(CIFAR(), os.path.join('.','models',"cifar"), [64, 64, 128, 128, 256, 256], num_epochs=50)
train(MNIST(), os.path.join('.','models',"mnist"), [32, 32, 64, 64, 200, 200], num_epochs=50)
train_distillation(MNIST(), os.path.join('.','models',"mnist-distilled-100"), [32, 32, 64, 64, 200, 200],num_epochs=50, train_temp=100)
train_distillation(CIFAR(), os.path.join('.','models',"cifar-distilled-100"), [64, 64, 128, 128, 256, 256],num_epochs=50, train_temp=100)
